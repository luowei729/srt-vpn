...
/// ⚠️ 2026-08-20 重构：streamid 静态令牌已废弃（连接认证改 srt_shell/auth.rs
/// 的 SRT 特征握手）。此函数保留仅供潜在兼容/参考，不再被生产路径调用。
#[allow(dead_code)]
...
/// ⚠️ 2026-08-20 重构：已废弃（同 derive_token），保留仅供参考。
#[allow(dead_code)]
